...
function sw_enqueue_script() {
	wp_enqueue_style( 'drag-and-drop', plugins_url( 'southwind-card-sorter/css/style.min.css' ), array(), '1.0.7' );
	wp_enqueue_script( 'sw-drag-and-drop', plugins_url( 'southwind-card-sorter/js/sw-draggable.js' ), array( 'jquery' ), '1.0.7' );
}
